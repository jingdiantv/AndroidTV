...
//                            }
                ...
                anim != null -> {
                    ...
                    handleChildSkeletonView { it.runAnimationChangeBackground(actualView.resources.getColor(
                        R.color.skeleton_elements_light_50), actualView.resources.getColor(R.color.skeleton_elements)) }
                }
            }
        }
    }
