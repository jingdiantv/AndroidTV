...
class TVChannelPresenter : Presenter() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup): ViewHolder {
        sDefaultBackgroundColor = ContextCompat.getColor(parent.context, com.kt.apps.resources.R.color.default_background)
        sSelectedBackgroundColor = ContextCompat.getColor(parent.context, com.kt.apps.resources.R.color.selected_background)
