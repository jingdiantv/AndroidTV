 ...
 */
abstract class BaseRowSupportFragmentLeanback extends Fragment {
    private static final String CURRENT_SELECTED_POSITION = "currentSelectedPosition";
    private ObjectAdapter mAdapter;
    protected VerticalGridView mVerticalGridView;
    protected PresenterSelector mPresenterSelector;
    protected ItemBridgeAdapter mBridgeAdapter = new ItemBridgeAdapter();
    protected int mSelectedPosition = -1;
    protected boolean mPendingTransitionPrepare;
